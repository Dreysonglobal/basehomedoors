document.addEventListener('DOMContentLoaded', function() {
    ...
    buyButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            const whatsappNumber = '+2348037740573';
            const message = `Hello Base Home Doors, I'm interested in your ${productName}. Please send me more details and pricing information.`;
